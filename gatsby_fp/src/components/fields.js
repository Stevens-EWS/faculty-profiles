...
export default function Fields ({ facultyData }){
 return(
  <>
      <h1 className="biotitle">{facultyData.pf_first_name} {facultyData.pf_last_name}</h1>
      ...
      {facultyData.education  &&
        <Education
          educationList={facultyData.education}
        />
      }
      ...
      {facultyData.service_university &&
        <UnivService
          univServiceList={facultyData.service_university}
        />
      }
      {facultyData.service_professional &&
        <ProfService
          profServiceList={facultyData.service_professional}
        />
      }
      {facultyData.consult_service &&
        <ConsultService
          consultService={facultyData.consult_service}
        />
      }
      {facultyData.appointment &&
        <Appointments
          appointments={facultyData.appointment}
        />
      }
      {facultyData.innovate_enterpreneur &&
        <InnovateEnt
          innovateEnt={facultyData.innovate_enterpreneur}
        />
      }
      {facultyData.honor_award &&
        <HonorAward
          honorAward={facultyData.honor_award}
        />
      }
      {facultyData.member &&
        <ProfSocieties
          profSocietiesList={facultyData.member}
        />
      }
      {facultyData.grant_contract &&
        <GrantContrFunds
          grantContrFunds={facultyData.grant_contract}
        />
      }
      {facultyData.patent_invention &&
        <PatentInv
          patentInv={facultyData.patent_invention}
        />
      }
      {facultyData.intellcont &&
        <IntellCont
          intellContList={facultyData.intellcont}
        />
      }
    </>
  )
